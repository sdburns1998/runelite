...
public class MouseRecorder implements Runnable {
   ...
   static final void method1189(Widget widget, int x, int y, int var3) {
      ...
      if (var4 != null) {
         ...
         if (Client.minimapState != 2 && Client.minimapState != 5) {
            int rotation = Client.camAngleY & 2047;
            int xOffset = Canvas.localPlayer.x / 32 + 48;
            int yOffset = 464 - Canvas.localPlayer.y / 32;
            InterfaceParent.sceneMinimapSprite.drawRotatedAndAlphaMapped(x, y, var4.width, var4.height, xOffset, yOffset, rotation, 256, var4.xStarts, var4.xWidths);
            ...
            for (var8 = 0; var8 < Client.mapIconCount; ++var8) {
               ...
               NetFileRequest.method4554(x, y, var9, var10, Client.mapIcons[var8], var4);
            }
            ...
            while (true) {
               ...
               if (var8 >= 104) {
                  for (var8 = 0; var8 < Client.npcCount; ++var8) {
                     ...
                     if (var17 != null && var17.isVisible()) {
                        ...
                        if (var14 != null && var14.drawMapDot && var14.isInteractable) {
                           ...
                           NetFileRequest.method4554(x, y, var11, var12, class39.mapDotSprites[1], var4);
                        }
                     }
                  }
                  ...
                  for (var10 = 0; var10 < var8; ++var10) {
                     ...
                     if (var19 != null && var19.isVisible() && !var19.isHidden && var19 != Canvas.localPlayer) {
                        ...
                        if (var19.isFriend()) {
                           NetFileRequest.method4554(x, y, var12, var15, class39.mapDotSprites[3], var4);
                        } else if (var16) {
                           NetFileRequest.method4554(x, y, var12, var15, class39.mapDotSprites[4], var4);
                        } else if (var19.isClanMember()) {
                           NetFileRequest.method4554(x, y, var12, var15, class39.mapDotSprites[5], var4);
                        } else {
                           NetFileRequest.method4554(x, y, var12, var15, class39.mapDotSprites[2], var4);
                        }
                     }
                  }
                  ...
                  if (Client.destinationX != 0) {
                     ...
                     NetFileRequest.method4554(x, y, var10, var11, class16.mapMarkerSprites[0], var4);
                  }
               ...
               for (var9 = 0; var9 < 104; ++var9) {
                  ...
                  if (var13 != null) {
                     ...
                     NetFileRequest.method4554(x, y, var11, var12, class39.mapDotSprites[0], var4);
                  }
               }
